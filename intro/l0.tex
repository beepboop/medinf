...
\frame{
\frametitle{Example -- herbal drug foalfoot}
\begin{enumerate}
 \item 10 g of herbal drug (2 spoons) place to enamel ware,
\item Add 200 ml (1 cup) of boiled room-temperature water
\item close cover and infuse on the water bath for 15 min
\item Cool down for 45 min at the room temperature
\item strain
\item press out the rest to the strained infusion
\item The infusion adds up with boiled water to 200 ml
\item Take 0, 5 cup of warm infusion two times a time 15 min before meal
% \item 
\end{enumerate}

%  , . , , press out the rest to the strained infusion. The infusion adds up with boiled water to 200 ml. Take 0, 5 cup of warm infusion two times a time 15 min before meal. 
